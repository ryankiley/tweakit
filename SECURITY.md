...
- Preferred: GitHub's private vulnerability reporting — the **Security** tab →
  **Report a vulnerability** ([new advisory](https://github.com/ryankiley/tweakability/security/advisories/new)).
...
Tweakability is a **dependency-free, client-side UI library** — it makes no network
