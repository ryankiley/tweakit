...
export const meta = {
  ...
  description: "Install tweakit, import a build, add the styles, and wire your first live parameter panel.",
};

export const intro = `
<p>Tweakit is a single npm package with no runtime dependencies. Install it,
